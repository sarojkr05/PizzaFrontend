...
function SignupPresentational({ handleUserInput, handleFormSubmit }) {
    return(
        <>
                    ...
                    <form className="flex flex-col w-full p-8 mt-10 bg-gray-100 rounded-lg lg:w-2/6 md:w-1/2 md:ml-auto md:mt-0" action="">
                        ...
                        <div className="relative mb-4">
                            ...
                            <input 
                              ...
                              minLength={5}
                              placeholder="John"
                              className="w-full px-3 py-1 rounded outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200"/>
