...
function Signup() {
    ...
    async function handleFormSubmit(e){
        ...
        if(signUpState.firstName.length < 5 || signUpState.firstName.length > 20) {
            toast.error("First name should be atleast five characters long and maximum twenty 20 long")
            return;
        }
        ...
        //Check mobile number length between 10-12
        if(signUpState.mobileNumber.length < 10 || signUpState.mobileNumber.length > 12) {
            toast.error("Mobile number should be between 10-12 charactes");
            return;
        }
