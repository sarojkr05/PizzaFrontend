...
function Order () {
    ...
    async function handleFormSubmit(e) {
        ...
        if(response?.payload?.data?.success) {
            ...
            toast.error('Something went wrong cannot placed order')
        }
    }
            ...
            <section className="text-gray-600 body-font min-h-56">
                ...
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <form onSubmit={handleFormSubmit}>
                        ...
                        <div className="relative flex-grow w-full">
                            <label htmlFor="address" className="leading-7 text-2xl text-gray-600 my-5">
                                Address
                            </label>
                            <textarea
                                name="address"
                                ...
                                required
                                onChange={handleUserInput}
                                className="w-full border rounded-md focus:outline-none focus:border-primary-500 bg-white text-gray-700"
