...
import CookImage from '../assets/Images/cookimage1.png'
import { IconPatchCheckFill } from "../Components/Icons/PatchCheckIcons";
                    ...
                    <div className="flex flex-col flex-wrap text-center lg:py-6 lg:w-1/2 lg:pl-12 lg:text-left">
                        ...
                        <div className="flex flex-col items-center lg:items-start">
                            <div>
                                ...
                                Cooked by professional <br /> chefs in the world
                                </h2>
                        ...
                        <div className="w-full p-1">
                            <div className="flex items-center h-full p-2 text-2xl rounded">
                                <IconPatchCheckFill className="text-[#F38339] w-10 h-10 mr-4"/>
                                <span className="font-bold title-font">Delivered safely</span>
                            </div>
                        ...
                        <div className="px-5 py-4 mx-auto">
                            ...
                            <div className="flex flex-wrap space-y-6 md:space-y-0">
                                ...
                                <div className="flex-grow">
                                    ...
                                    <p className="text-base leading-relaxed">
                                        As soon as your get your order, enjoy the delicious pizza with your loved ones.
                                    </p>
                                </div>
